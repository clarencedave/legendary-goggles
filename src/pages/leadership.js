...
<div class="row">
    <div class="column">
        ...
        <div class="column">
             <div class="container">
                 <div class="card">
                    <img src={name} alt="Jane" class="avatar" />
        <h2>Keith Laepple</h2>
        <p class="title">Fund Manager, SAC VI</p>
...
Formerly a 22-year manager in operating system products at Microsoft, Keith has led teams in program management, technical evagelism, and business development for PC, mobile, and consumer electronics platforms.  </p>
        ...
        <div class="column">
            <div class="container">
                <div class="card">
                    <img src={forever} alt="Jane" class="avatar" />
        <h2>Geoff Harris</h2>
        <p class="title">Fund Manager SAC VII</p>
...
<div class="column">
        <div class="container">
            <div class="card">
                 <img src= {yolo} alt="Avatar" class="avatar"/>
        <h2> Josh Maher </h2>
        <p class="title">Fund Manager, SAC V</p>
    ...
    <div class="column">
        <div class="container">
            <div class="card">
                 <img src= {solo} alt="Avatar" class="avatar"/>
        <h2> Brad Carpenter </h2>
        <p class="title">Fund Manager, SAC IV</p>
